...
class RoutingExample {
  ...
  final _HOME_GEO_COORDINATES = GeoCoordinates(10.7845766, 106.6212572);
  ...
  Future<void> addRoute(
    ...
    // var startGeoCoordinates = _HOME_GEO_COORDINATES;
    ...
    for (Section section in route.sections) {
      ...
      for (Toll toll in tolls) {
        ...
        for (TollFare tollFare in toll.fares) {
          ...
          // authorities.
          print("Toll price: " +
              tollFare.price.toString() +
              " " +
              tollFare.currency);
          for (PaymentMethod paymentMethod in tollFare.paymentMethods) {
            print("Accepted payment methods for this price: " +
  ...
  GeoCoordinates _createRandomGeoCoordinatesInViewport() {
    ...
    if (geoBox == null) {
      ...
      return GeoCoordinates(10.7845766, 106.6212572);
    }
  ...
  void _animateToRoute(here.Route route) {
    ...
    MapCameraAnimation animation =
        MapCameraAnimationFactory.createAnimationFromUpdateWithEasing(update,
            const Duration(milliseconds: 3000), Easing(EasingFunction.inCubic));
